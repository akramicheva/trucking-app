...
Формат строки подключения указан в файле appsettings.Example.json
...
Пароль должен содержать как минимум 6 символов, содержать как минимум одну uppercase букву и один специальный символ (nonalphanumeric).
